...
export function generateMetadata() {
    return {
        ...
        description: "Here are some of my projects that I have worked on , I love building prototypes and solving real world problems , I am an active participant in hackathons too ( have won a few of them) as I love building protoypes in a rushing enviroment. I was also a finalist in Placeholder Hackathon 2023",
        openGraph: {
