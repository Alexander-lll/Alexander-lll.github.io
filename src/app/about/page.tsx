...
export function generateMetadata() {
    return {
        ...
        description: "Hi. I'm Alexander, a machine learning engineer from the CA, Bay Area. I am a machine learning engineer, I love building software that solves real world problems which is probably why everything I build is Open Source. My everyday tech stack includes transformers, PyTorch, TensorFlow, Pythons, ...",
        openGraph: {
        ...
        <section className=" p-4 w-full lg:max-w-[50%] lg:m-auto">
            <div className="flex flex-col gap-4">
                ...
                <p className="text-md lg:text-2xl flex flex-col gap-2 whitespace-break-spaces font-normal">
                    <span>
                        Hey , stranger 👋 I&apos;m Alexander, a machine learning engineer from the CA, Bay Area. I&apos;m a <span className=" text-[#FF9D00] font-bold">Machine Learning Engineer</span> that occasionally contributes to{" "}
                ...
                <div className="flex gap-2 flex-wrap mt-2 mb-2 items-center">
                    ...
                    <a href="mailto:aplaceholder@mail.com?body=Hello" target="_blank" rel="noopener noreferrer">
                ...
                <p className=" text-md lg:text-2xl whitespace-break-spaces font-normal">
                    ...
                    <a href="mailto:aplaceholder@mail.com?body=Hello" rel="noopener noreferrer" target="_blank" className=" text-blue-500 italic font-bold">
                        aplaceholder@mail.com
                    </a>
                    ) and{" "}
