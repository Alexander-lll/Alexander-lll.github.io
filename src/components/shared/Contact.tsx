...
const Contact = () => {
    ...
    return (
        <div className="flex justify-center items-center gap-5 flex-col" id="contact">
            ...
            <a href="mailto:alexanderdrivas@icloud.com?body=Hello" target="_blank" className="flex items-center gap-2 text-xl font-medium">
                <MailPlus /> alexanderdrivas@icloud.com
            </a>
